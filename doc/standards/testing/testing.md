...
- **BehaviorSpec Style**: Use Kotest's BehaviorSpec style with "arrange" phase code in the "Given"
  block, "act" phase code in the "When" block, and "assert" phase code in the "Then" block.
