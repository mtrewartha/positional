...
public class CompassView extends android.support.v7.widget.AppCompatImageView {
    ...
    static final public float TIME_DELTA_THRESHOLD = 0.15f; // maximum time difference between iterations, s
    ...
    static final public float ALPHA_DEFAULT = 15;
    static final public float MB_DEFAULT = 3000;
